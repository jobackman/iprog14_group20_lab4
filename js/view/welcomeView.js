...
// 	</div>
	...
	div1.html('<h1>A Home Dinner Service</h1><hr class="divider"><p>"Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum."<br></p><p>Start quickly</p><button type="submit" class="btn btn-default" id="startButton">Create new Dinner</button>');
	parent.append(div1);
