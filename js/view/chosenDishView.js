	...
	var chosenDish = $("<div>");
		...
		var md6Ingredient = $("<div>");
			...
			for (i=0; i<dish.ingredients.length; i++){
				var quantityAndUnit = dish.ingredients[i].quantity* model.getNumberOfGuests() + " " + dish.ingredients[i].unit;
			...
			md6Ingredient.html('<h3>Ingredients for: ' + model.getNumberOfGuests() + ' people' + '</h3><table class="table">'+ loopedIngredients +'<tr><td colspan="2"><button type="submit" class="btn btn-default" id="confirmDish">Confirm Dish</button></td><td><strong>Total: </strong></td><td>'+this.totalPrice+'</td></tr>');
